...
set "REPO_SSH=git@github.com:Sxd55/astrbot_plugin_savagereply.git"
set "REPO_WEB=https://github.com/Sxd55/astrbot_plugin_savagereply"
set "KEY=%USERPROFILE%\.ssh\id_ed25519"

echo.
echo === Savage's Reply upload ===
echo Working dir: %CD%
...
if errorlevel 1 (
  git commit -m "Update astrbot_plugin_savagereply"
) else (
...
echo    Name: astrbot_plugin_savagereply   Visibility: Public
