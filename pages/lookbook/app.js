...
const FRAMES = [
  {
    ...
    points: [
      ...
      "理想区间断句：15–50 字寻找最强停顿；找不到则弹性延伸，120 字强制落刀",
      "末段不足 8 字并回上一段；段数上限 6，超出自动合并防刷屏",
  ...
  },
  {
    ...
    keys: [
      ...
      },
      {
        key: "typing_enabled",
        name: "打字状态",
        hint: "私聊等待期间显示「对方正在输入」；群聊与其他平台自动跳过。",
      },
    ],
    facts: [
      ["每字打字", () => "0.08 s"],
